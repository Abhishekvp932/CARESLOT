...
const services = [
  {
    ...
    title: "Cardiology",
    description:
      "Expert heart and cardiovascular care from board-certified cardiologists.",
  ...
  },
  {
    ...
    title: "Orthopedics",
    description:
      "Specialized care for bones, joints, and musculoskeletal health.",
...
const features = [
  {
    ...
    description:
      "Book appointments in minutes with flexible scheduling options.",
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    description:
      "All healthcare professionals are verified and board-certified.",
  },
  {
    icon: Zap,
    title: "Instant Consultations",
    description:
      "Get video consultations with doctors from the comfort of your home.",
  },
];
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-primary/5 to-accent/5">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 text-balance">
              Connect with qualified healthcare professionals across multiple
              specialties. Book appointments, get consultations, and manage your
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Access a wide range of medical specialties with experienced
        ...
        >
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Experience healthcare reimagined with modern technology and
                professional care.
              </p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto bg-gradient-to-r from-primary to-accent rounded-2xl p-12 text-center text-primary-foreground">
            ...
            <p className="text-lg mb-8 opacity-90">
              Join thousands of patients who trust HealthHub for their
              healthcare needs.
            </p>
