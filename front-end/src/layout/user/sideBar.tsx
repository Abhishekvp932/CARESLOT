...
const navigate = useNavigate();
  ...
  return (
    <div className="relative flex">
      <div
        className={`bg-white shadow-lg border-r border-gray-200 h-screen transition-all duration-300 ease-in-out flex flex-col ${
      ...
      <button
        ...
        className="absolute top-1/2 -translate-y-1/2 left-full -ml-4 z-50 p-2 rounded-l-lg bg-white shadow-lg border border-gray-200"
      >
        {isCollapsed ? (
