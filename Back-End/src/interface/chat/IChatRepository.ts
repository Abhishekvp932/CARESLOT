...
export interface IChatRepository{
    create(chatData:Partial<IChat>,session?:ClientSession):Promise<IChat | null>
    ...
    findByPatientIdAndUpdate(patientId:string,doctorId:string,filter?:FilterQuery<IChat>,session?:ClientSession):Promise<IChat | null>;
}