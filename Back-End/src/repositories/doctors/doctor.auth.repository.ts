...
export class DoctorAuthRepository
  ...
  implements IDoctorAuthRepository
{
  constructor() {
    super(Doctor);
  }
  async updateById(
    doctorId: string,
    update: UpdateQuery<IDoctor>
  ): Promise<IDoctor | null> {
    return await this.model.findByIdAndUpdate(doctorId, update, { new: true });
  }
