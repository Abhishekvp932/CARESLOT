...
class AuthController {
    ...
    signup(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { name, email, password, dob, gender, phone, confirmPassword } = req.body;
                const result = yield this.authService.signup(name, email, password, phone, dob, gender);
                //  console.log('undefined ith anno',result)
